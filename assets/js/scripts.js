...
// Validate form
var toastHTML = '<span>Đã gửi</span><button onclick="M.Toast.dismissAll()" class="btn-icon waves-effect toast-action"><i class="material-icons">close</i></button>';
$.validate({
  form: "#contact_form",
...
$(document).ready(function(){
  var toastHTML = '<span>Đã gửi</span><button onclick="M.Toast.dismissAll()" class="btn-icon waves-effect toast-action me-1"><i class="material-icons">close</i></button>';
  $.validate({
    form: "#contact_form",
    onSuccess: function(form) {
      M.toast({html: toastHTML});
...
// IMEI Check form
var toastHTML = '<span>Đang Check</span><button onclick="M.Toast.dismissAll()" class="btn-icon waves-effect toast-action"><i class="material-icons">close</i></button>';
$.validate({
  form: "#checkImei_form",
  onSuccess: function(form) {
    M.toast({html: toastHTML});
...
var toastHTML2 = '<span>Đang Check</span><button onclick="M.Toast.dismissAll()" class="btn-icon waves-effect toast-action"><i class="material-icons">close</i></button>';
$.validate({
  form: "#checkfmi_form",
  onSuccess: function(form) {
...
/**
 * @name form
 * @function handle IMEI Check form
 */

$(document).ready(function(){
  var toastHTML = '<span>Đang Check</span><button onclick="M.Toast.dismissAll()" class="btn-icon waves-effect toast-action me-1"><i class="material-icons">close</i></button>';
  $.validate({
    form: "#checkImei_form",
    onSuccess: function(form) {
      M.toast({html: toastHTML});
